...
detect_face.py script perform MTCNN operation for detecting faces.
facenet.py script performs creating of directory based on labels.
it create aligned face directory by using MTCNN.
CONSTRAINS:
if there is no face detected it skip the alignment process.
or
if the image having the dimension less than two it will skip the alignment process.
